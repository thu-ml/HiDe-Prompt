...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--datasets', default=['Split-Imagenet-R'], type=list, nargs="*", help="datasets")
    subparsers.add_argument('--continual_classes_per_dataset', default=[160], type=int, nargs="*", help="num continual classes per dataset")
    subparsers.add_argument('--few_shot_classes_per_dataset', default=[40], type=int, nargs="*", help="num few shot classes per dataset")
    subparsers.add_argument('--tasks_per_dataset', default=[8], type=int, nargs="*", help="num tasks per dataset")
    ...
    subparsers.add_argument('--num_fs_epochs', default=20, type=int, help='num fs epochs')
    subparsers.add_argument('--fs_lr', default=0.001, type=float, help='fs lr')
    subparsers.add_argument('--fs_backbone', default='shared', type=str, choices=['vanilla', 'shared', 'vanilla+shared'], help='fs backbone')
